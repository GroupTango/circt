...
protected:  
  ...
  std::string getInputNamespace(const std::string &ns) { return ns + "/Inputs"; }
  std::string getOutputNamespace(const std::string &ns) { return ns + "/Outputs"; }
};
